...
const tdCanvasAgentMcp = tdCanvasAgentMcpCommand();
...
function codexConfig(permissionMode: AgentPermissionMode) {
    return { model_reasoning_summary: "auto", ...(permissionMode === "automatic" ? { approvals_reviewer: "auto_review" } : {}), mcp_servers: { tdcanvas: { command: tdCanvasAgentMcp.command, args: tdCanvasAgentMcp.args, default_tools_approval_mode: "approve", startup_timeout_sec: 20, tool_timeout_sec: 90 } } };
}
