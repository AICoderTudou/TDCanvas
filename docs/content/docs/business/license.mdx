...
description: TDCanvas licensing and usage boundaries
---

# Open-source License

TDCanvas is licensed under the GNU Affero General Public License v3.0 (AGPL-3.0). You may use, copy, modify, and distribute it while complying with the license.
