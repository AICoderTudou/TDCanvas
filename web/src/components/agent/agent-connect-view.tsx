...
const AGENT_PLUGIN_REMOVE_COMMAND = "codex plugin remove tdcanvas";
const AGENT_MCP_REMOVE_COMMAND = "codex mcp remove tdcanvas";
...
export function AgentConnectView({
    ...
    const steps = [{ title: t("agent.connect.pluginTitle"), text: t("agent.connect.pluginText") }, { title: t("agent.connect.directTitle"), text: t("agent.connect.directText"), command: "npm --prefix canvas-agent run dev" }];
