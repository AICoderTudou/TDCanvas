...
type AgentClientGlobal = typeof globalThis & { __tdcanvasAgentClientIdPromise?: Promise<string> };
...
function acquireAgentClientId() {
    ...
    scope.__tdcanvasAgentClientIdPromise ||= (async () => {
        ...
        while (true) {
            const acquired = await new Promise<boolean>((resolve, reject) => {
                void navigator.locks.request(`tdcanvas-agent:${clientId}`, { ifAvailable: true }, async (lock) => {
    ...
    return scope.__tdcanvasAgentClientIdPromise;
}
