...
import { Camera, Copy, FileText, Grid2x2, Lock, LockOpen, Maximize2, Scissors, Upload, ZoomIn } from "lucide-react";

import type { CanvasNodeData } from "@/types/canvas";
import i18n from "@/i18n";

export type ImageNodeActionToolId = "copyPrompt" | "reversePrompt" | "replace" | "resize" | "crop" | "split" | "upscale" | "angle" | "view";
...
export const IMAGE_QUICK_TOOLS_STORAGE_KEY = "tdcanvas:image-quick-tools-v6";
