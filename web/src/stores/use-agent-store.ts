...
export const useAgentStore = create<AgentStore>((set, get) => ({
    width: typeof window === "undefined" ? 440 : Number(localStorage.getItem("tdcanvas:agent-panel-width")) || 440,
    panelOpen: false,
    panelMounted: true,
    panelClosing: false,
    canvasContext: null,
    url: typeof window === "undefined" ? "http://127.0.0.1:17371" : localStorage.getItem("tdcanvas:agent-url") || "http://127.0.0.1:17371",
    token: typeof window === "undefined" ? "" : localStorage.getItem("tdcanvas:agent-token") || "",
    connected: false,
    enabled: false,
    silentConnect: false,
    prompt: "",
    ...
    activeTab: "setup",
    confirmTools: false,
    permissionMode: typeof window === "undefined" ? "request" : (localStorage.getItem("tdcanvas:agent-permission-mode") as AgentPermissionMode) || "request",
    models: [],
    model: typeof window === "undefined" ? "" : localStorage.getItem("tdcanvas:agent-model") || "",
    reasoningEffort: typeof window === "undefined" ? "" : (localStorage.getItem("tdcanvas:agent-reasoning-effort") as AgentReasoningEffort) || "",
    ...
    connectAgent: (options) => {
        ...
        localStorage.setItem("tdcanvas:agent-url", endpoint);
        localStorage.setItem("tdcanvas:agent-token", token);
